...
print("=" * 60)
print("CLAUDE AGENT TEAM — SMOKE TEST")
print("=" * 60)
print(f"\nLIDER: claude-opus-4-7 (Claude Max abonelik, key gerekmez)")
...
print("=" * 60)
keys = [
    "OPENROUTER_API_KEY", "OPENAI_API_KEY", "GOOGLE_API_KEY", "GEMINI_API_KEY",
    ...
    "PERPLEXITY_API_KEY", "DEEPINFRA_API_KEY", "NVIDIA_API_KEY",
    "HUGGINGFACE_API_KEY", "HYPERBOLIC_API_KEY", "SAMBANOVA_API_KEY",
]
for k in keys:
